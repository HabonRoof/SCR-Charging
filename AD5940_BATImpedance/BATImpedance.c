...
static AD5940Err AppBATSeqCfgGen(void)
{
  ...
  hs_loop.WgCfg.WgType = WGTYPE_SIN;		//Disturbance waveform type WGTYPE_SIN or WGTYPE_TRAPZ
  ...
  hs_loop.WgCfg.SinCfg.SinPhaseWord = 0;
	...
	hs_loop.WgCfg.TrapzCfg.WGTrapzDCLevel1 =  2048;		//Trapz wave configuration
	hs_loop.WgCfg.TrapzCfg.WGTrapzDCLevel2 =  0;
	hs_loop.WgCfg.TrapzCfg.WGTrapzDelay1 = 1200;
	hs_loop.WgCfg.TrapzCfg.WGTrapzDelay2 = 1200;
	hs_loop.WgCfg.TrapzCfg.WGTrapzSlope1 =  0;
	hs_loop.WgCfg.TrapzCfg.WGTrapzSlope2 =  0;
